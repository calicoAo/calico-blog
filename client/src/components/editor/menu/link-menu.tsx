...
export const LinkMenu = ({ editor }: { editor: Editor }) => {
  ...
  return (
    ...
    >
      <div className='flex flex-row items-center gap-1 rounded-md border bg-white p-2 dark:bg-zinc-800'>
        {isEditing ? (
          ...
          <div className='flex flex-col gap-2'>
            <a
              ...
              target={target}
              title={link}
              className='max-w-[200px] overflow-hidden text-sm text-ellipsis whitespace-nowrap text-blue-500'
            >
              {link}
            </a>
