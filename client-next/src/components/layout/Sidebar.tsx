...
const sidebarBackground = '/assets/sidebar_back.JPG';
const logoBackground = '/assets/logo_back.png';
          ...
          {navItems.map((item) => {
            return (
              ...
              >
                <Link
                  href={item.path}
                  className="cursor-pointer select-none text-right text-2xl text-white font-black uppercase tracking-wide mr-8 hover:text-amber-300 transition-colors duration-200 no-underline block"
                  style={{ color: 'white' }}
                >
                  {item.label}
                </Link>
