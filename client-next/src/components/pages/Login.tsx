...
const Login: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setErrors({
        general: error instanceof Error ? error.message : '网络错误，请检查网络连接或稍后重试'
      });
      setIsLoading(false);
    }
  };
      ...
      >
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-200">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-sm">仅管理员账户可以登录</p>
          </div>
        ...
        {process.env.NODE_ENV === 'development' && (
          ...
          >
            ...
            <p>API地址：{process.env.NEXT_PUBLIC_API_BASE_URL || 'http://localhost:3001/api'}</p>
